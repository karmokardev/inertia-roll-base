...
* @see app/Http/Controllers/Admin/RoleController.php:38
* @route '/roles/create'
*/
...
* @see app/Http/Controllers/Admin/RoleController.php:47
* @route '/roles'
*/
...
* @see app/Http/Controllers/Admin/RoleController.php:75
* @route '/roles/{role}'
*/
...
* @see app/Http/Controllers/Admin/RoleController.php:94
* @route '/roles/{role}'
*/
