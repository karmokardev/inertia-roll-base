...
* @see app/Http/Controllers/Admin/PermissionController.php:39
* @route '/permissions'
*/
...
* @see app/Http/Controllers/Admin/PermissionController.php:57
...
* @see app/Http/Controllers/Admin/PermissionController.php:68
* @route '/permissions/{permission}'
*/
...
const PermissionController = { index, create, store, edit, update, destroy }
