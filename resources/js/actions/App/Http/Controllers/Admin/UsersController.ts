...
* @see app/Http/Controllers/Admin/UsersController.php:46
* @route '/users/{user}'
*/
...
* @see app/Http/Controllers/Admin/UsersController.php:60
...
* @see app/Http/Controllers/Admin/UsersController.php:72
* @route '/users/{user}'
*/
...
const UsersController = { index, edit, update, updateStatus, destroy }
